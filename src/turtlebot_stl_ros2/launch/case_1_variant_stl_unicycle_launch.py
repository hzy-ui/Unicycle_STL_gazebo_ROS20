...
def generate_launch_description():
    ...
    params = {
        ...
        "goals": [
            2.,   3.5,  0.,  50.,  47.,          # Goal 1: x, y, start, end, expect, remember to add ., or the data will NOT be loaded, 第一个点不能和当前车的朝向垂直不然没法解
            4.,   0.,   50., 80.,  77.,          # Goal 2: x, y, start, end, expect
            4.,   3.,   80., 110., 107.          # Goal 3: x, y, start, end, expect
        ],
