...
def generate_launch_description():
    ...
    params = {
        ...
        "goals": [
            ...
            2., 4., 40., 60.,  57.,          # Goal 3: x, y, start, end, expect, INTERSECTS with goal 2
            4., 0., 60., 90.,  87.,          # Goal 4: x, y, start, end, expect
            4., 3., 85., 120., 117.,         # Goal 5: x, y, start, end, expect, INTERSECTS with goal 4
        ],
